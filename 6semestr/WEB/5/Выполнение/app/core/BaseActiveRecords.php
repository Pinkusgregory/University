...
class BaseActiveRecords {
    ...
    public static function setupConnection() {
        if (!isset(static::$pdo)) {
            try {
                static::$pdo = new PDO("pgsql:dbname=web2; host=localhost;", "postgres", "");
    ...
    public static function findByPage($offset, $rowsPerPage) {
        ...
        $result = [];
        $sql = "SELECT * FROM ".static::$tablename." ORDER BY date DESC LIMIT ".$rowsPerPage." OFFSET ".$offset;
        $stmt = static::$pdo->query($sql);
